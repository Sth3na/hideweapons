...
public plugin_init()
{
 ...
 register_clcmd("say /hdskins", "offSkins");
...
public offSkins( id )
{
 g_iOffSkins[ id ] = !g_iOffSkins[ id ];
 client_print( id, print_center, "%stivaste tus skins", g_iOffSkins[ id ] ? "Ac" : "Desac")
...
{
 if(!is_user_alive(id) || !g_iOffSkins[ id ])
 {
